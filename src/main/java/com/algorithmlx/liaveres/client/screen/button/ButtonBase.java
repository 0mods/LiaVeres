...
public class ButtonBase extends Button {
    ...
    public ButtonBase(int x, int y, int width, int height, Component text, OnPress onPress, ResourceLocation texture) {
    ...
    public ButtonBase(int x, int y, int width, int height, String text, OnPress onPress, ResourceLocation texture) {
        this(x, y, width, height, Component.literal(text), onPress, texture);
    }

    public ButtonBase(int x, int y, int width, int height,  OnPress onPress, ResourceLocation texture) {
