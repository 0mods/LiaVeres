...
//        UpgradeRecipeBuilder.smithing(Ingredient.of(ingredient), Ingredient.of(Registration.GILDED_NETHERITE_INGOT.get()), result).unlocks("crafting_table", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.CRAFTING_TABLE)).save(consumer, new ResourceLocation(Constants.ModId, result.getId().getPath() + "_smithing"));
//    }
//
...
//                .save(consumer, new ResourceLocation(Constants.ModId, result.getRegistryName().getPath() + "_upgrade"));
//    }
//
...
//                .requires(ingredient)
//                .unlockedBy("any", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.ANY))
//                .save(consumer, new ResourceLocation(Constants.ModId, ingredient.asItem().getRegistryName().getPath() + "_uncraft"));
//    }
//
...
//                .unlockedBy("any", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.ANY))
//                .save(consumer, new ResourceLocation(Constants.ModId, result.asItem().getRegistryName().getPath()));
//    }
//
//    private void craftingTable(String pattern, String pattern1, String pattern2, Character symbol, Character symbol1,
