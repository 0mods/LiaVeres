package com.algorithmlx.liaveres.api.util.container;

import com.algorithmlx.liaveres.api.util.ContainedItem;
import com.algorithmlx.liaveres.api.util.tools.ContainerTag;
import com.algorithmlx.liaveres.api.util.tools.Scale.*;
...
public class SizedContainer extends AdvancedContainerMenu {
    ...
    public SizedContainer(int windowId, Inventory playerInventory, InteractionHand hand) {
        super(LVRegister.SC.get(), windowId, playerInventory);
